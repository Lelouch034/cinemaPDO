                ...
                <div class="uk-width-auto uk-height-match" uk-scrollspy="target: > div; cls: uk-animation-fade; delay: 500">
                    <div class="uk-card uk-card-small uk-card-default uk-height-match uk-border-rounded">
                        <figure class="uk-height-match uk-border-rounded">
                            <!-- Utilisez l'ID du film pour créer un lien dynamique -->
                            <a href="view/film/filmDetails.php?id=<?= $film['id_film'] ?>">
...
<?php
$title = "List of Films";
$content = ob_get_clean(); // Exécute successivement ob_get_contents() et ob_end_clean(). Lit le contenu courant du tampon de sortie puis l'efface
